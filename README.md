...
FullBars is an iOS app that scans, grades, and visualizes your home Wi-Fi coverage room by room using ARKit and RoomPlan. Walk through each room with your iPhone and get a signal-quality grade (A–D), heatmap overlay, dead-zone detection, speed test history, and actionable recommendations for improving coverage.
...
- **Heatmap & dead zones** — visualize signal strength across your floor plan and pinpoint weak spots.
